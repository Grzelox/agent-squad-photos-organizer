...
class TestImageAnalysisService:
    ...
    def sample_metadata_df(self):
        ...
        return pd.DataFrame({
            ...
            "filepath": ["/path/photo1.jpg", "/path/photo2.jpg", "/path/photo3.jpg"],
    ...
    def test_init(self, temp_photos_dir):
        ...
        assert service.supported_formats == {".jpg", ".jpeg", ".png", ".bmp", ".tiff", ".webp"}

    def test_encode_image_to_base64_success(self, image_analysis_service, sample_image_path):
    ...
    def test_encode_image_to_base64_invalid_file(self, image_analysis_service, temp_photos_dir):
    ...
    def test_calculate_image_similarity_same_hash(self, image_analysis_service):
        ...
        similarity = image_analysis_service.calculate_image_similarity(hash_value, hash_value)
    ...
    def test_calculate_image_similarity_invalid_hash(self, image_analysis_service):
        ...
        result = image_analysis_service.calculate_image_similarity("invalid", "also_invalid")
        assert result == 0.0

    @patch('services.image_analysis_service.cv2.imread')
    ...
    @patch('services.image_analysis_service.cv2.imread')
    def test_extract_image_features_none_image(self, mock_imread, image_analysis_service):
    ...
    @patch('services.image_analysis_service.cv2.imread')
    def test_extract_image_features_exception(self, mock_imread, image_analysis_service):
    ...
    def test_find_similar_images_no_similar(self, image_analysis_service, sample_metadata_df):
        ...
        with patch.object(image_analysis_service, 'get_image_hash') as mock_hash:
            ...
            result = image_analysis_service.find_similar_images(sample_metadata_df, similarity_threshold=0.9)
            assert result == {}

    def test_find_similar_images_with_similar(self, image_analysis_service, sample_metadata_df):
        """Test finding similar images when similar images exist."""
        # Mock the get_image_hash method to return some similar hashes
        with patch.object(image_analysis_service, 'get_image_hash') as mock_hash:
            mock_hash.side_effect = ["0000000000000000", "0000000000000000", "8000000000000000"]  # First two are similar
            
            result = image_analysis_service.find_similar_images(sample_metadata_df, similarity_threshold=0.8)
    ...
    def test_load_analysis_results_invalid_json(self, image_analysis_service, temp_photos_dir):
    ...
    @patch('services.image_analysis_service.cv2.imread')
    def test_extract_image_features_different_sizes(self, mock_imread, image_analysis_service):
    ...
    def test_find_similar_images_different_thresholds(self, image_analysis_service, sample_metadata_df):
        ...
        with patch.object(image_analysis_service, 'get_image_hash') as mock_hash:
            ...
            hash_values = ["0000000000000000", "0000000000000000", "8000000000000000"]  # First two are similar
            mock_hash.side_effect = hash_values * 4  # Repeat for 4 threshold tests
            
            # Test with different thresholds
            thresholds = [0.5, 0.8, 0.9, 0.99]
            for threshold in thresholds:
                result = image_analysis_service.find_similar_images(sample_metadata_df, similarity_threshold=threshold)
                assert isinstance(result, dict)

    def test_save_and_load_analysis_results_roundtrip(self, image_analysis_service, temp_photos_dir):
    ...
    @patch('services.image_analysis_service.cv2.imread')
    def test_extract_image_features_color_analysis(self, mock_imread, image_analysis_service):
    ...
    def test_get_image_hash_different_formats(self, image_analysis_service, temp_photos_dir):
    ...
    def test_encode_image_to_base64_different_sizes(self, image_analysis_service, temp_photos_dir):
