...
class TestAIService:
    ...
    @patch('services.ai_service.ollama.list')
    ...
    @patch('services.ai_service.ollama.chat')
    def test_analyze_image_with_text_success(self, mock_ollama_chat, ai_service, mock_ollama_response):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_analyze_image_with_text_connection_error(self, mock_ollama_chat, ai_service):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_analyze_image_with_text_model_not_found(self, mock_ollama_chat, ai_service):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_analyze_multiple_images_success(self, mock_ollama_chat, ai_service, mock_ollama_response):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_compare_images_with_prompt(self, mock_ollama_chat, ai_service, mock_ollama_response):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_compare_images_default_prompt(self, mock_ollama_chat, ai_service, mock_ollama_response):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_analyze_photos_metadata_success(self, mock_ollama_chat, ai_service, mock_ollama_response):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_suggest_organization_strategy_success(self, mock_ollama_chat, ai_service, mock_ollama_response):
    ...
    @patch('services.ai_service.ollama.chat')
    def test_answer_photo_question_success(self, mock_ollama_chat, ai_service, mock_ollama_response):
        """Test successful photo question answering."""
        mock_ollama_chat.return_value = mock_ollama_response
        
        result = ai_service.answer_photo_question(
            "How many photos do I have?", 
            "You have 100 photos from 2020-2023"
        )
    ...
    @patch('services.ai_service.ollama.chat')
    def test_generate_organization_plan_success(self, mock_ollama_chat, ai_service, mock_ollama_response):
    ...
    @patch('services.ai_service.ollama.list')
    @patch('services.ai_service.ollama.pull')
    def test_ensure_model_available_model_exists(self, mock_pull, mock_list, ai_service):
    ...
    @patch('services.ai_service.ollama.list')
    @patch('services.ai_service.ollama.pull')
    def test_ensure_model_available_model_missing(self, mock_pull, mock_list, ai_service):
    ...
    @patch('services.ai_service.ollama.list')
    @patch('services.ai_service.ollama.pull')
    def test_ensure_model_available_pull_failure(self, mock_pull, mock_list, ai_service):
